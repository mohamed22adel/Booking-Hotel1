...
<div className="title_contact">
    ...
    <img className="hotel_img_contact" style={{opacity:"1px"}} src={require("./Images/hotel_interface1.jpg")} alt="i"/>
...
<span className="Your_Email_contact">Your Email</span>
        ...
        <div className="second_div_middle_contact">
<h6>contact us</h6>
<h1>Get In Touch</h1>
<p className="p_one">We'd love to hear from you! Whether you have a question, a comment,
    or just want to chat, feel free to reach out.
    We're always here to help and look forward to connecting with you!
    Feel free to customize the email address and phone number to fit your needs.
    If there's anything else you need, just let me know!</p>
    <div className="third_div_middle_contact">
    ...
    <div className="b">
        <h4><i class="fa-regular fa-envelope"></i>Email Us</h4>
        <p>contact@company.com</p>
    </div>

    </div>

    <div className="forth_div_middle_contact">

        <div className="c">
            <h4><i class="fa-solid fa-earth-africa"></i>Website</h4>
            <p>www.Romancy.com</p>
        </div>
        <div className="d">
            <h4><i class="fa-solid fa-location-dot"></i>Address</h4>
            <p>1234 street name,city 4444</p>
        </div>

    </div>
<div className="fifth_div_middle_contact">
    <h4>Follow Us On</h4>
...
<img className="youtube_logo" src={require("./Images/youtube.logo.png")} alt="i"/></button>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512" fill="#4267B2"><path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path></svg></button>
        ...
        <div className="googleMap" style={{width: "100%"}}><iframe width="100%" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=cairo+(Romancy%20Hotel)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/">gps tracker sport</a></iframe></div>
