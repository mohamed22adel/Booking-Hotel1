...
export default function BookingRoomPage3(){
    ...
    return(
        <div className="book_room_container">
            <Navbar/>
<h5 className="h5_1">DISCOVER OUR LUXURY SUITES</h5>
...
<div className="room_container">
<div className="room_container_div">
<img style={{width:"395px",height:"263.33px",borderRadius:"20px",position:"relative",right:"10px"}} src={require("./Images/rooooom7.jpg")} alt="i"/>
    <div className="room_price">
        <h4>$2700</h4>
        <p>For night</p>
    </div>
...
<div className="book_room_pages">
    <ul>
        ...
        <Link to="/Executive Suites"><li onClick={scrollToTop}>2</li></Link>
        <Link to="/Luxury Suites"><li onClick={scrollToTop} style={{backgroundColor:"#f2c335"}}>3</li></Link>
    </ul>
</div>
